...
function CarouselIndicator({
    ...
    // Indicators for steps? Or per item? 
    // Usually per page or per item. If per item, limiting is tricky visually.
    // Keeping it per item for now but could limit.
    return (
        <div
            className={cn(
...
function CarouselContent({
    ...
    const { index, setIndex, setItemsCount, disableDrag, visibleItemsCount, setVisibleItemsCount } = useCarousel();
